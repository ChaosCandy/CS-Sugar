...
local function on_character_select_load()
    CT_CHARNAME2 = _G.charSelect.character_add("Sugar", {"A shockingly talented and violent", "magical slime girl! <3"}, "SourChaosCandy / Sugar", {r = 168, g = 28, b = 206}, E_MODEL_CUSTOM_MODEL, CT_CHARNAME2, TEX_CUSTOM_LIFE_ICON)
